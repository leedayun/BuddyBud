...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onResume() {
        ...
        editTextEmail.setText(Data.loginRemember ? Data.loginEmail : "");
        editTextPassword.setText("");
        checkBoxRemember.setChecked(Data.loginRemember);
    }
    ...
    protected void onPause() {
        ...
        EditText editTextEmail = findViewById(R.id.editTextEmail);
        Data.loginEmail = editTextEmail.getText().toString();
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        checkBoxRemember.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Data.loginRemember = checkBoxRemember.isChecked();
            }
        });
